...
<script src="<?php echo base_url()?>public/bookshop/js/jquery/jquery-ui.js"></script>
...
<link rel="stylesheet" href="<?php echo base_url()?>public/bookshop/css/jquery-ui.css" type="text/css" media="screen"/>
